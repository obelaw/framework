...
use Obelaw\UI\Exceptions\Forms\PushAlertErrorException;
use Obelaw\UI\Exceptions\Forms\PushAlertWarningException;
...
abstract class FormRender extends Component
{
    ...
    public function submit()
    {
        ...
        try {
            $this->doSubmit($inputs);
        } catch (PushAlertWarningException $e) {
            $this->pushAlert('warning', $e->getMessage());
        } catch (PushAlertErrorException $e) {
